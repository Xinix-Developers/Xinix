...
static inline unsigned int stdc_leading_zeros_ui(unsigned int _value) _ATTRIBUTE_UNSEQ {
...
static inline unsigned int stdc_leading_zeros_uc(unsigned char _value) _ATTRIBUTE_UNSEQ {
#if __has_builtin(__builtin_clzg)
...
static inline unsigned int stdc_leading_zeros_us(unsigned short _value) _ATTRIBUTE_UNSEQ {
#if __has_builtin(__builtin_clzg)
...
static inline unsigned int stdc_leading_zeros_ul(unsigned long _value) _ATTRIBUTE_UNSEQ {
#if __has_builtin(__builtin_clzg)
...
static inline unsigned int stdc_leading_zeros_ull(unsigned long long _value) _ATTRIBUTE_UNSEQ {
#if __has_builtin(__builtin_clzg)
...
#define _STDBIT_DEF_GENERIC_MAP(value, prefix, ...) _Generic((value), unsigned char: prefix## _uc((value) __VA_OPT__(,) __VA_ARGS__),\
                                                unsigned _BitInt(8): prefix## _uc((unsigned char)(value) __VA_OPT__(,) __VA_ARGS__),\
                                                unsigned short: prefix## _us((value) __VA_OPT__(,) __VA_ARGS__),\
                                                unsigned _BitInt(16): prefix## _us((unsigned short)(value) __VA_OPT__(,) __VA_ARGS__),\
                                                unsigned int: prefix## _ui((value) __VA_OPT__(,) __VA_ARGS__),\
                                                unsigned _BitInt(32): prefix## _ui((unsigned int)(value) __VA_OPT__(,) __VA_ARGS__),\
                                                unsigned long: prefix## _ul((value) __VA_OPT__(,) __VA_ARGS__),\
                                                unsigned long long: prefix## _ull((value) __VA_OPT__(,) __VA_ARGS__),\
                                                unsigned _BitInt(64): prefix## _ull((unsigned long long)(value) __VA_OPT__(,) __VA_ARGS__)\
                                            )

#define stdc_leading_zeros(value) _STDBIT_DEF_GENERIC_MAP(value, stdc_leading_zeros)


#if __has_builtin(__builtin_stdc_rotate_right)
#define _STDBIT_DEF_ROTATE_RIGHT_FN(ty, suffix)\
                        static inline ty stdc_rotate_right_ ## suffix(ty _value, unsigned int _count){\
...
#define _STDBIT_DEF_ROTATE_RIGHT_FN(ty, suffix)\
                        static inline ty stdc_rotate_right_ ## suffix(ty _value, unsigned int _count) {\
                            ...
                            return ((_value) >> (_count & _width)) | ((_value) << (_width - (_count & _width)));\
                        }
#endif

#if __has_builtin(__builtin_stdc_rotate_left)
#define _STDBIT_DEF_ROTATE_LEFT_FN(ty, suffix)\
                        static inline ty stdc_rotate_left_## suffix(ty _value, unsigned int _count){\
...
#define stdc_rotate_right(value, count) _STDBIT_DEF_GENERIC_MAP(value, stdc_rotate_right, count)
...
#define stdc_rotate_left(value, count) _STDBIT_DEF_GENERIC_MAP(value, stdc_rotate_left, count)